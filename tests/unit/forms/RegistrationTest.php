...
class RegistrationTest extends \tests\codeception\Unit
{
    ...
    public function testValidator()
    {
        ...
        $this->specify(
            'tests required fields', function () use ($faker) {
        ...
        $this->specify(
            'tests email must have length > 4', function () use ($faker) {
                $form = new Registration;
        ...
        $this->specify(
            'tests passwords must match', function () use ($faker) {
                $form = new Registration;
                $form->email = $faker->email;
        ...
        $this->specify(
            'tests model validation', function () use ($faker) {
                $form = new Registration;
    ...
    public function testRegistration()
    {
        $faker = \Faker\Factory::create();
        $this->specify(
            'tests registration', function () use ($faker) {
                $form = new Registration;
